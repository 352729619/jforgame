...
public class SqlFactory {
    ...
    public static String createTable(OrmBridge bridge) {
        StringBuilder sb = new StringBuilder();
        sb.append(" CREATE TABLE IF NOT EXISTS ");
        sb.append(bridge.getTableName()).append(" (");
        ...
        for (int i = 0; i < properties.size(); i++) {
            ...
            sb.append("`" + column + "`" + " ");
            sb.append(ColumnFieldDes.getDes(column, bridge));
            sb.append(",");
        }
        //添加主键
        String KEY = bridge.getQueryProperties().get(0);
        sb.append("PRIMARY KEY(`" + KEY + "`)").append(" );");
